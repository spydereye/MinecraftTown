...
public class StructureLayoutGen {
    ...
    public static final DeferredRegister<MapCodec<? extends StructureModifier>> STRUCTURES = DeferredRegister.create(ForgeRegistries.STRUCTURE_MODIFIER_SERIALIZERS, firstmod.MOD_ID);
    ...
    public static void placeStructure(ServerLevel world, BlockPos pos, String structureName) {
        // Load the structure
        ResourceLocation location = ResourceLocation.tryBuild(firstmod.MOD_ID, structureName);
